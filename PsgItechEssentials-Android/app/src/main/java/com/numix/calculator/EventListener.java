...
public class EventListener implements View.OnKeyListener, View.OnClickListener, View.OnLongClickListener {
    ...
    private boolean returnToBasic() {
        if(mPager != null && mPager.getCurrentItem() != Calculator.Panel.BASIC.getOrder() && CalculatorSettings.returnToBasic(mContext)) {
            mPager.setCurrentItem(Calculator.Panel.BASIC.getOrder());
            return true;
        }
        return false;
    }

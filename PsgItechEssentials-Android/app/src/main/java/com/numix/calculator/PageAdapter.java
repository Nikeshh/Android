...
public class PageAdapter extends CalculatorPageAdapter {
    ...
    public View getViewAt(int position) {
        View v = null;
        if(position == Calculator.Panel.GRAPH.getOrder() && CalculatorSettings.graphPanel(mParent.getContext())) {
        ...
        else if(position == Calculator.Panel.FUNCTION.getOrder() && CalculatorSettings.functionPanel(mParent.getContext())) {
            v = mFunctionPage;
        }
        else if(position == Calculator.Panel.BASIC.getOrder() && CalculatorSettings.basicPanel(mParent.getContext())) {
            v = mSimplePage;
        }
        else if(position == Calculator.Panel.ADVANCED.getOrder() && CalculatorSettings.advancedPanel(mParent.getContext())) {
            v = mAdvancedPage;
        }
        else if(position == Calculator.Panel.HEX.getOrder() && CalculatorSettings.hexPanel(mParent.getContext())) {
            v = mHexPage;
        }
        else if(position == Calculator.Panel.MATRIX.getOrder() && CalculatorSettings.matrixPanel(mParent.getContext())) {
            return mMatrixPage;
        }

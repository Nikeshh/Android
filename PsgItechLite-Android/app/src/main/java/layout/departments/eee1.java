...
public class eee1 extends Activity implements SurfaceHolder.Callback{
    ...
    public void button3(View view) {
        ...
        if (button_text.equals("Timeline")) {
            ...
            Intent intent = new Intent(this, com.extensions.ext4_1.class);
            startActivity(intent);
        } else if (button_text.equals("Academic Activities")) {
            Intent intent = new Intent(this, com.extensions.ext4_2.class);
            startActivity(intent);
        }
        else if (button_text.equals("Non-Academic Activities")) {
            Intent intent = new Intent(this, com.extensions.ext4_3.class);
            startActivity(intent);
        }
        else if (button_text.equals("Association")) {
            Intent intent = new Intent(this, com.extensions.ext4_4.class);
            startActivity(intent);
        }
        else if (button_text.equals("Learn More")) {
            Intent intent = new Intent(this, com.extensions.ext4_5.class);
            startActivity(intent);
        }
        else if (button_text.equals("Faculty Profile")) {
            Intent intent = new Intent(this, layout.otheractivities.facultyprofile4.class);
            startActivity(intent);
        }

package com.nikeshhbaskaran.psgitechmini.android.student;
...
import com.nikeshhbaskaran.psgitechmini.android.faculty.GroupMail;
...
public class HomeActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void groupmailnext(View view) {
        ...
        if (button_text.equals("Student Details")) {
            ...
            Intent intent = new Intent(this, com.nikeshhbaskaran.psgitechmini.details.class);
            startActivity(intent);
        } else if (button_text.equals("Group Mail")) {
            Intent intent = new Intent(this, GroupMail.class);
            startActivity(intent);
        }
